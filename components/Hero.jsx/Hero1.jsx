...
const HomePage = () => {
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="w-full max-w-screen-xl p-4 md:p-8 bg-gray-900 shadow-lg rounded-lg text-center text-[#e74c3c]">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-[#e74c3c] mb-4 font-poppins">
          Typing Practice for All
        </h1>
        <p className="text-sm md:text-base lg:text-lg text-[#7f8c8d] mb-8 font-poppins">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <div
              ...
              <div className="bg-[#ffffff19] p-6 rounded-lg text-center transition-transform transform hover:scale-105 hover:bg-[#e74c3c] hover:bg-opacity-100">
                {button.icon}
                <p className="font-semibold text-base lg:text-lg text-[#bdc3c7] font-poppins">
                  {button.text}
                </p>
              </div>
              <div className="hidden group-hover:block absolute top-0 left-0 w-full h-full bg-opacity-75 bg-white transition-opacity opacity-0 hover:opacity-100">
                <p className="h-full flex items-center justify-center text-sm md:text-base lg:text-lg text-gray-900 font-poppins">
                  {button.text}
                </p>
              </div>
            </div>
